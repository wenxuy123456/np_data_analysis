...
def process_condition_group(files, condition):
    ...
    output_file_fig5 = os.path.join(fig5_dir, f"np_detachment_fig5_4420_{condition}_combined_sorted.xlsx")
...
def main():
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(script_dir, "outputs", "4420_all_conditions.png"), dpi=150, bbox_inches="tight")
