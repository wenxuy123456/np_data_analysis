...
fig5_file_list = [
    os.path.join(fig5_dir, "np_detachment_fig5_4M2.4_hh.xlsx"),
    os.path.join(fig5_dir, "np_detachment_fig5_4M2.4_hl.xlsx"),
    os.path.join(fig5_dir, "np_detachment_fig5_4M2.4_lh.xlsx"),
    os.path.join(fig5_dir, "np_detachment_fig5_4M5.3_hh.xlsx"),
    os.path.join(fig5_dir, "np_detachment_fig5_4M5.3_hl.xlsx"),
    os.path.join(fig5_dir, "np_detachment_fig5_4M5.3_lh.xlsx"),
...
def fig5_sorted_df():
    ...
    for file in fig5_file_list:
        all_conformations[file] = process_fig5_file(file)
...
def main():
    ...
    for file, df_sorted_fig5 in all_fig5_data.items():
        label = os.path.basename(file).replace(".xlsx", "")
        plot_fig5_decay_curve(df_sorted_fig5, label)

    plt.legend(loc="best", fontsize="small")

    os.makedirs(os.path.join(script_dir, "outputs"), exist_ok=True)
    plt.savefig(os.path.join(script_dir, "outputs", "all_anti_comparison.png"), dpi=150, bbox_inches="tight")
