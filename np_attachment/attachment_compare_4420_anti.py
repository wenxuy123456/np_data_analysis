...
fig3_file_list = [
    os.path.join(fig3_dir, "np_attachment_fig3_4420_anti_mh.xlsx"),
    os.path.join(fig3_dir, "np_attachment_fig3_4420_anti_lh.xlsx"),
    os.path.join(fig3_dir, "np_attachment_fig3_4420_anti_lm.xlsx"),
    os.path.join(fig3_dir, "np_attachment_fig3_4420_anti_mm.xlsx"),
    os.path.join(fig3_dir, "np_attachment_fig3_4420_anti_hl.xlsx"),
    os.path.join(fig3_dir, "np_attachment_fig3_4420_anti_hm.xlsx"),
]
