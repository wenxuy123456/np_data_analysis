...
fig3_file_list = [
    r"..\web_plot_data/np_attachment_fig3/np_attachment_fig3_4420_anti_mh.xlsx",
    r"..\web_plot_data/np_attachment_fig3/np_attachment_fig3_4420_anti_lh.xlsx",
    r"..\web_plot_data/np_attachment_fig3/np_attachment_fig3_4420_anti_lm.xlsx",
    r"..\web_plot_data/np_attachment_fig3/np_attachment_fig3_4420_anti_mm.xlsx",
    r"..\web_plot_data/np_attachment_fig3/np_attachment_fig3_4420_anti_hl.xlsx",
    r"..\web_plot_data/np_attachment_fig3/np_attachment_fig3_4420_anti_hm.xlsx",
]
...
def main():
    ...
    for file, df_sorted_fig3 in all_fig3_data.items():
        ...
        plt.savefig(f"outputs/4420_anti_{label}.png", dpi=150, bbox_inches="tight")
