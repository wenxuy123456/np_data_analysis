...
fig3_file_list = [
    os.path.join(fig3_dir, "np_attachment_fig3_4M5.3_scfv_lm.xlsx"),
    os.path.join(fig3_dir, "np_attachment_fig3_4M5.3_scfv_lh.xlsx"),
    os.path.join(fig3_dir, "np_attachment_fig3_4M5.3_scfv_mm.xlsx"),
    os.path.join(fig3_dir, "np_attachment_fig3_4M5.3_scfv_mh.xlsx"),
    os.path.join(fig3_dir, "np_attachment_fig3_4M5.3_scfv_hl.xlsx"),
    os.path.join(fig3_dir, "np_attachment_fig3_4M5.3_scfv_hm.xlsx"),
    os.path.join(fig3_dir, "np_attachment_fig3_4M5.3_scfv_hh.xlsx"),
]
...
def main():
    ...
    for file, df_sorted_fig3 in all_fig3_data.items():
        ...
        plt.savefig(f"outputs/4M53_scfv_{label}.png", dpi=150, bbox_inches="tight")
