...
fig3_file_list = [
    r"..\web_plot_data/np_attachment_fig3/np_attachment_fig3_VIII_scfv_mrfp_mh.xlsx",
    r"..\web_plot_data/np_attachment_fig3/np_attachment_fig3_VIII_scfv_mrfp_hm.xlsx",
    r"..\web_plot_data/np_attachment_fig3/np_attachment_fig3_VIII_scfv_mrfp_hh.xlsx",
]
...
def main():
    ...
    for file, df_sorted_fig3 in all_fig3_data.items():
        ...
        plt.savefig(f"outputs/VIII_scfv_mrfp_{label}.png", dpi=150, bbox_inches="tight")
