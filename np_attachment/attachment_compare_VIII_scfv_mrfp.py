...
fig3_file_list = [
    os.path.join(fig3_dir, "np_attachment_fig3_VIII_scfv_mrfp_mh.xlsx"),
    os.path.join(fig3_dir, "np_attachment_fig3_VIII_scfv_mrfp_hm.xlsx"),
    os.path.join(fig3_dir, "np_attachment_fig3_VIII_scfv_mrfp_hh.xlsx"),
]
