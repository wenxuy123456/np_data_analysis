...
fig3_file_list = [
    os.path.join(fig3_dir, "np_attachment_fig3_4420_scfv_hh.xlsx"),
    os.path.join(fig3_dir, "np_attachment_fig3_4420_scfv_lm.xlsx"),
    os.path.join(fig3_dir, "np_attachment_fig3_4420_scfv_lh.xlsx"),
    os.path.join(fig3_dir, "np_attachment_fig3_4420_scfv_mm.xlsx"),
    os.path.join(fig3_dir, "np_attachment_fig3_4420_scfv_mh.xlsx"),
    os.path.join(fig3_dir, "np_attachment_fig3_4420_scfv_hl.xlsx"),
    os.path.join(fig3_dir, "np_attachment_fig3_4420_scfv_hm.xlsx"),
]
