...
fig3_file_list = [
    r"..\web_plot_data/np_attachment_fig3/np_attachment_fig3_4420_scfv_hh.xlsx",
    r"..\web_plot_data/np_attachment_fig3/np_attachment_fig3_4420_scfv_lm.xlsx",
    r"..\web_plot_data/np_attachment_fig3/np_attachment_fig3_4420_scfv_lh.xlsx",
    r"..\web_plot_data/np_attachment_fig3/np_attachment_fig3_4420_scfv_mm.xlsx",
    r"..\web_plot_data/np_attachment_fig3/np_attachment_fig3_4420_scfv_mh.xlsx",
    r"..\web_plot_data/np_attachment_fig3/np_attachment_fig3_4420_scfv_hl.xlsx",
    r"..\web_plot_data/np_attachment_fig3/np_attachment_fig3_4420_scfv_hm.xlsx",
]
...
def main():
    ...
    for file, df_sorted_fig3 in all_fig3_data.items():
        ...
        plt.savefig(f"outputs/4420_scfv_{label}.png", dpi=150, bbox_inches="tight")
